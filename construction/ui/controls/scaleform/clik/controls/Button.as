...
package scaleform.clik.controls
{
	...
	public class Button extends UIComponent
	{
		...
		protected var _stateMap:Object = {up: ["up"], over: ["over"], down: ["down"], release: ["release", "over"], out: ["out", "up"], disabled: ["disabled"], selecting: ["selecting", "over"], toggle: ["toggle", "up"], kb_selecting: ["kb_selecting", "up"], kb_release: ["kb_release", "out", "up"], kb_down: ["kb_down", "down"]}
		/** @private */
		...
		protected function handleMouseRollOut(event:MouseEvent):void
		{
			...
			if (event.buttonDown)
			{
				...
				{
					if (stage != null)
					{ // Button may have just been removed from stage, firing a MouseRollOut. Stage will be null in this case.
		...
		protected function handleRepeat(event:TimerEvent):void
		{
			...
			if (_autoRepeatEvent)
			{ // In theory, mousePressEvent should never be null here.
				_isRepeating = true;
