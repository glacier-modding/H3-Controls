			...
			while (_loc4_ < param1.buttonprompts.length)
			{
				...
				else
				{
					...
					while (_loc7_ < _loc6_.actionTypes.length)
					{
						...
						_loc3_ -= 62;
						_loc9_ = {"actiontype": _loc8_.name, "hidePrompt": _loc8_.hidePrompt, "actionlabel": "", "transparentPrompt": _loc8_.transparentPrompt, "disabledPrompt": _loc8_.disabledPrompt};
				...
				if (!ButtonPrompt.shouldSkipPrompt(_loc6_))
				{
					...
					else if (_loc7_.actionTypes != null)
					{
						...
						while (_loc8_ < _loc7_.actionTypes.length)
						{
							...
							_loc11_ = {"actiontype": _loc9_.name, "hidePrompt": _loc9_.hidePrompt, "actionlabel": (_loc10_ ? _loc6_.actionlabel : ""), "transparentPrompt": _loc9_.transparentPrompt, "disabledPrompt": _loc9_.disabledPrompt};
		...
		private function getActionType(param1:Object):ActionType
		{
			...
			else if (typeof param1.actiontype == "object")
			{
				...
				for each (_loc3_ in param1.actiontype)
				{
					if (_loc3_ is String)
					{
						_loc2_.actionTypes.push({"name": _loc3_ as String, "hidePrompt": false});
					}
					else
					{
