package hud.notification
{
	...
	public class ChallengesBar extends NotificationListener
	{
		...
		{
			var sCategory:String = param1;
			var sDescription:String = param2;
			var iData:Object = param3;
			...
			if (iData != null && iData.sImage != null && iData.sImage != "")
			{
				...
				Animate.to(this.m_view.checkmark_mc, 0.3, 1.8, {"alpha": 1, "scaleX": 1, "scaleY": 1}, Animate.ExpoOut);
