package hud
{
	...
	public class OutfitWidgetVR extends BaseControl
	{
		...
		private function repositionImage(param1:Boolean):void
		{
			if (param1)
			{
				Animate.fromTo(this.m_container, DT_ANIMDURATION, DT_ANIMDELAY + 0.5, {"x": -50, "alpha": 0}, {"x": 0, "alpha": 1}, Animate.ExpoOut);
			}
			else
			{
		...
		private function repositionTextFields(param1:Boolean):void
		{
			if (param1)
			{
				Animate.fromTo(this.m_txtHeader, DT_ANIMDURATION, DT_ANIMDELAY + 0.8, {"x": 50, "alpha": 0}, {"x": 8, "alpha": 1}, Animate.ExpoOut);
				Animate.fromTo(this.m_txtOutfitName, DT_ANIMDURATION, DT_ANIMDELAY + 1, {"x": 50, "alpha": 0}, {"x": 8, "alpha": 1}, Animate.ExpoOut);
			}
			else
			{
