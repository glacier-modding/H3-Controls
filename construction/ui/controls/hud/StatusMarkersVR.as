   ...
   public class StatusMarkersVR extends BaseControl
   {
      ...
      private function onTensionBarAnimStep1(param1:int) : void
      {
         Animate.fromTo(this.m_tensionIndicatorMc.iconMc,0.1,0,{
            ...
            "scaleX":1,
            "scaleY":1
         },Animate.Linear,this.onTensionBarAnimStep2,param1);
      }
      ...
      private function onTensionBarAnimStep2(param1:int) : void
      {
         Animate.fromTo(this.m_tensionIndicatorMc.labelTxt,0.1,0,{
            ...
            "alpha":1,
            "x":21
         },Animate.Linear,this.onTensionBarAnimStep3,param1);
      }
...
class ObjlikeQueue
{
   ...
   private function animateAppearance(param1:DisplayObject, param2:DisplayObject, param3:TextField, param4:Number) : void
   {
      ...
      param2.scaleX = 0;
      param2.scaleY = 0;
      Animate.to(param2,0.3,0,{
         "scaleX":1,
         "scaleY":1
      },Animate.ExpoOut);
      Animate.to(param3,0.3,0.2,{
         "x":30,
         "alpha":1
      },Animate.ExpoOut);
      Animate.kill(param1);
