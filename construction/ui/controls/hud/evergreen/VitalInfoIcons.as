package hud.evergreen
{
	...
	public class VitalInfoIcons extends BaseControl
	{
		...
		private var m_assassinIcon:EvergreenVitalInfoIcons_view;
		
		private var m_lookoutIcon:EvergreenVitalInfoIcons_view;
		...
		public function VitalInfoIcons()
		{
			...
			this.m_assassinIcon = new EvergreenVitalInfoIcons_view();
			this.m_lookoutIcon = new EvergreenVitalInfoIcons_view();
			super();
		...
		public function onSetData(param1:Object):void
		{
			...
			if (Boolean(data.isAssassinNearby) || Boolean(data.isAssassinAlerted))
			{
				...
				Animate.to(this.m_assassinIcon.icon_mc, 0.3, 0.1, {"scaleX": 1, "scaleY": 1}, Animate.SineInOut);
				this.m_assassinIcon.back_mc.scaleX = this.m_assassinIcon.back_mc.scaleY = 1.3;
				Animate.to(this.m_assassinIcon.back_mc, 0.2, 0, {"scaleX": 1, "scaleY": 1}, Animate.SineInOut);
			}
			else
			{
			...
			if (Boolean(data.isLookoutNearby) || Boolean(data.isLookoutAlerted))
			{
				...
				Animate.to(this.m_lookoutIcon.icon_mc, 0.3, 0.1, {"scaleX": 1.2, "scaleY": 1.2}, Animate.SineInOut);
				this.m_lookoutIcon.back_mc.scaleX = this.m_lookoutIcon.back_mc.scaleY = 1.3;
				Animate.to(this.m_lookoutIcon.back_mc, 0.2, 0, {"scaleX": 1, "scaleY": 1}, Animate.SineInOut);
			}
			else
			{
