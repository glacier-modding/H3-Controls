package hud.evergreen
{
	...
	public class EconomyWidget extends BaseControl
	{
		...
		private function startNotificationAnimation(param1:int, param2:int):void
		{
			...
			this.m_view.notification_txt.alpha = 0;
			Animate.to(this.m_view.notification_txt, 0.2, 0, {"alpha": 1, "y": yMid, "x": this.notifEndX}, Animate.SineOut, Animate.to, this.m_view.notification_txt, 0.2, 1, {"alpha": 0, "y": yEnd, "x": xEnd}, Animate.SineIn, function():void
			{
		...
		private function animateIcon():void
		{
			...
			Animate.to(this.m_view.icon_mc, 0.2, 0.07, {"scaleX": 1, "scaleY": 1}, Animate.SineOut);
		}
	}
}
