package hud.evergreen
{
	...
	public class MenuOverlayContainer extends BaseControl
	{
		...
		public function onMenuOpening(param1:Number):void
		{
			...
			Animate.to(this.m_slideContainerL, _loc2_, param1 - _loc2_, {"alpha": 1, "x": this.m_xLeft}, Animate.ExpoOut);
			Animate.to(this.m_slideContainerR, _loc2_, param1 - _loc2_, {"alpha": 1, "x": this.m_xRight}, Animate.ExpoOut);
		}
		...
		public function onMenuClosing(param1:Number):void
		{
			...
			var _loc2_:Number = Math.min(param1, this.m_dtSlideAnimDuration);
			Animate.to(this.m_slideContainerL, _loc2_, 0, {"alpha": 0, "x": this.m_xLeft - this.m_dxSlideAnimOffset}, Animate.ExpoIn);
			Animate.to(this.m_slideContainerR, _loc2_, 0, {"alpha": 0, "x": this.m_xRight + this.m_dxSlideAnimOffset}, Animate.ExpoIn);
		}
