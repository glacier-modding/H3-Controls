	...
	public class HeadlineComponent extends Sprite implements IMenuOverlayComponent
	{
		...
		private function updateLayout():void
		{
			...
			else
			{
				...
				{
					Animate.addTo(this.m_background, 0.1, 0, {"y": this.m_yBottom - DYMARGINBOTTOM - dyBackgroundHeight, "height": dyBackgroundHeight}, Animate.SineOut);
				}
			}
		}
	}
	...
	public function onSetData(param1:Object):void
	{
		...
		while (_loc5_ < _loc7_)
		{
			...
			if (_loc6_ == 0)
			{
				_loc9_.scaleX = 0;
				_loc9_.scaleY = 0;
				Animate.to(_loc9_, 0.1, 0, {"scaleX": 1, "scaleY": 1}, Animate.SineOut);
			}
			_loc5_++;
		}
		if (_loc7_ > 0)
