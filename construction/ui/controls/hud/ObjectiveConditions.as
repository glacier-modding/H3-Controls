	...
	public class ObjectiveConditions extends BaseControl
	{
		...
		public function onSetData(param1:Array):void
		{
			...
			while (this.i < param1.length)
			{
				...
				{
					_loc4_ = {"header": "", "title": _loc3_.npcName, "icon": _loc5_, "line": true, "hardCondition": true};
				}
				else
				{
					_loc4_ = {"header": _loc3_.disguiseName, "title": _loc3_.npcName, "icon": _loc5_, "line": true, "hardCondition": true};
				}
