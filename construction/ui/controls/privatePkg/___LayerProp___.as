package privatePkg
{
   ...
   public class ___LayerProp___ extends MovieClip
   {
      ...
      public static function executeFrameHelper(param1:MovieClip) : *
      {
         ...
         {
            if((_loc4_ = graphicFrameSync(_loc2_.currentFrame,_loc3_.totalFrames,_loc2_["firstFrame"],_loc2_["lastFrame"],_loc2_["loopMode"])) != _loc3_.currentFrame || _loc4_ != param1.currentFrame)
            {
      ...
      private static function graphicFrameSync(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number) : Number
      {
         ...
         if(param4 <= 0)
         {
            ...
            {
               if((_loc6_ = param1 + param3 - 1) > param2)
               {
                  _loc6_ = param2;
               }
            }
         ...
         else
         {
            ...
            {
               if((_loc6_ = param3 - minNum(param1,_loc7_ - 1)) < 0)
               {
                  _loc6_ += param2;
               }
            }
            ...
            {
               if((_loc6_ = param3 - param1 % _loc7_) < 0)
               {
                  _loc6_ += param2;
               }
            }
