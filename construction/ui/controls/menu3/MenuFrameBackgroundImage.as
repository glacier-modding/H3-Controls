	...
	public class MenuFrameBackgroundImage extends Sprite
	{
		...
		private function setNewMainImage(param1:BitmapData):void
		{
			...
			for each (bgImage in this.m_bgImages)
			{
				...
				{
					Animate.fromTo(bgImage.m_root, blendInAnimationDuration, 0, {"scaleX": targetScale, "scaleY": targetScale, "x": posX, "y": posY}, {"scaleX": 1, "scaleY": 1, "x": 0, "y": 0}, Animate.ExpoOut);
				}
			}
