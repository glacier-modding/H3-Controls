package menu3
{
   ...
   public dynamic class OpportunityItemDetails extends MenuElementBase
   {
      ...
      public function OpportunityItemDetails(param1:Object)
      {
         super(param1);
      }
      ...
      {
         MenuUtils.setupTextAndShrinkToFit(this.m_view.Body.title,param1,28,MenuConstants.FONT_TYPE_MEDIUM,this.m_view.Body.title.width,-1,24,MenuConstants.FontColorWhite);
