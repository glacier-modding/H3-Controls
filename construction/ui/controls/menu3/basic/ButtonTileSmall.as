package menu3.basic
{
	...
	public dynamic class ButtonTileSmall extends ButtonTileBase
	{
		
		public function ButtonTileSmall(param1:Object)
		{
			super(param1);
			m_view = new ButtonTileSmallView();
			m_view.tileSelect.alpha = 0;
			m_view.tileBg.alpha = 0;
			addChild(m_view as ButtonTileSmallView);
			initView();
		}
