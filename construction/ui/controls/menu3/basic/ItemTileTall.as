package menu3.basic
{
   ...
   public dynamic class ItemTileTall extends MenuElementTileBase
   {
      ...
      public function ItemTileTall(param1:Object)
      {
         this.m_textObj = {};
         super(param1);
      ...
      private function showTimer(param1:String, param2:String) : void
      {
         ...
         MenuUtils.setupText(this.m_timeindicator.header,param2,18,MenuConstants.FONT_TYPE_NORMAL,MenuConstants.FontColorWhite);
         MenuUtils.truncateTextfield(this.m_timeindicator.header,1,MenuConstants.FontColorWhite);
         this.m_countDownTimer.startCountDown(this.m_timeindicator.title,param1,this);
      }
