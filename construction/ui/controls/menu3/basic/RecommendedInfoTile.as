package menu3.basic
{
   ...
   public dynamic class RecommendedInfoTile extends MenuElementTileBase
   {
      ...
      public function RecommendedInfoTile(param1:Object)
      {
         super(param1);
      ...
      override public function onSetData(param1:Object) : void
      {
         ...
         MenuUtils.setupTextAndShrinkToFitUpper(this.m_view.descriptionHeader,param1.descriptionHeader,36,MenuConstants.FONT_TYPE_MEDIUM,280,-1,18,MenuConstants.FontColorWhite);
         MenuUtils.setupText(this.m_view.descriptionBody,param1.descriptionBody,18,MenuConstants.FONT_TYPE_NORMAL,MenuConstants.FontColorWhite);
         if(param1.showUnlock === true)
         {
            MenuUtils.setupTextUpper(this.m_view.header,param1.unlockHeader,12,MenuConstants.FONT_TYPE_NORMAL,MenuConstants.FontColorWhite);
            MenuUtils.setupTextUpper(this.m_view.title,param1.unlockTitle,26,MenuConstants.FONT_TYPE_MEDIUM,MenuConstants.FontColorWhite);
            MenuUtils.setupIcon(this.m_view.tileIcon,param1.unlockIcon,MenuConstants.COLOR_WHITE,true,false);
         }
         else
         {
