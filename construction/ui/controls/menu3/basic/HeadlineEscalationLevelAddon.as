package menu3.basic
{
	...
	public dynamic class HeadlineEscalationLevelAddon extends MenuElementBase
	{
		...
		public function HeadlineEscalationLevelAddon(param1:Object)
		{
			super(param1);
		...
		{
			var _loc5_:EscalationLevelIconView = null;
			var _loc2_:int = 0;
			var _loc3_:int = 1;
			var _loc4_:int = 0;
			while (_loc4_ < param1.totallevels)
			{
				_loc5_ = new EscalationLevelIconView();
				...
				_loc5_.x = _loc2_;
				_loc2_ += MenuConstants.escalationLevelIconXOffset;
				_loc3_ += 1;
				_loc4_++;
			}
		}
