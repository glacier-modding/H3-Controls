	...
	public dynamic class OptionsInfoSplashHintPreview extends OptionsInfoPreview
	{
		...
		override public function onSetData(param1:Object):void
		{
			...
			else
			{
				...
				this.m_shContent.onSetData({"header": this.m_lstrHeader, "title": this.m_lstrTitle, "description": this.m_lstrDescription, "imageRID": "", "hinttype": MenuConstants.SPLASH_HINT_TYPE_GLOBAL, "iconID": "disguise"});
