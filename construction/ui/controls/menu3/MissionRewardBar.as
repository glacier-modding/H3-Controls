package menu3
{
	...
	public class MissionRewardBar
	{
		...
		public function animateHideBar():void
		{
			...
			Animate.to(this.m_view.mastery_txt, 0.2, 0, {"alpha": 0, "y": this.m_view.mastery_txt.y + 10}, Animate.ExpoOut);
			Animate.to(this.m_view.xpnum_txt, 0.4, 0, {"alpha": 0, "x": this.m_view.xpnum_txt.x - 15}, Animate.ExpoOut);
		...
		public function showXPLeft():void
		{
			...
			Animate.legacyTo(this.m_view.xpnum_txt, 0.5, {"alpha": 1, "x": this.m_view.xpnum_txt.x + 15}, Animate.ExpoOut);
		}
		...
		private function initXPBar():void
		{
			...
			Animate.legacyTo(this.m_view.mastery_txt, 0.3, {"alpha": 1, "y": this.m_view.mastery_txt.y - 15}, Animate.ExpoOut);
			...
			Animate.legacyTo(this.m_view.masteryLevelMc, 0.4, {"alpha": 1, "scaleX": 1, "scaleY": 1}, Animate.ExpoOut);
		...
		private function updateXPFields():void
		{
			...
			if (this.m_displayLevel > this.m_last_level)
			{
				...
				Animate.legacyTo(this.m_view.masteryLevelMc, 0.3, {"alpha": 0, "scaleX": 0, "scaleY": 0}, Animate.ExpoOut);
				Animate.delay(this.m_view.masteryLevelMc, 0.2, function():void
				{
					...
					Animate.legacyTo(m_view.masteryLevelMc, 0.4, {"alpha": 1, "scaleX": 1, "scaleY": 1}, Animate.ExpoOut);
				});
			}
			this.m_last_level = this.m_displayLevel;
