package hud
{
	...
	public class DroppedItemVR extends BaseControl
	{
		...
		public function onItemAutoDropped(param1:Object):void
		{
		...
		private function animateArrows():void
		{
			...
			this.m_pulsateCounter += 1;
		}
		
		private function animateIcon():void
		{
			Animate.to(this.m_view.icon_mc, 0.4, 0, {"alpha": 1, "y": -20}, Animate.ExpoOut, function():void
			{
				Animate.to(m_view.icon_mc, 0.8, 0, {"y": 0}, Animate.Linear, function():void
				{
					Animate.to(m_view.icon_mc, 0.4, 0, {"y": 80, "alpha": 0}, Animate.ExpoOut, function():void
					{
