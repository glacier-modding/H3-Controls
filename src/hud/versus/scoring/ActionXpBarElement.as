package hud.versus.scoring
{
	...
	public class ActionXpBarElement extends NotificationListener
	{
		...
		override public function ShowNotification(param1:String, param2:String, param3:Object):void
		{
			...
			var _loc11_:Object = {"element": _loc4_, "elementindex": this.m_yposArray.length, "description": _loc5_, "xpgain": param3.xpGain, "headerxoffset": _loc7_ / -2, "awesomeness": _loc9_, "fontColor": _loc6_, "isRepeated": param3.isRepeated};
		...
		private function endAnimation(param1:Object):void
		{
			...
			Animate.to(param1.element.info, 0.2, 0.2, {"alpha": 1, "scaleX": 1, "scaleY": 1}, Animate.ExpoOut);
			...
			if (!param1.isRepeated)
			{
				...
				Animate.to(param1.element.bg, 0.8, 0, {"scaleX": _loc3_, "alpha": 0}, Animate.ExpoOut);
			}
