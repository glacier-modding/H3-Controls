package hud.sniper
{
	...
	public class ChallengeElement extends BaseControl
	{
		...
		public function ShowNotification(param1:String, param2:String, param3:uint, param4:uint, param5:Boolean, param6:String, param7:String, param8:Number, param9:String):void
		{
			var scaleFactorX:Number;
			var title:String = param1;
			var icon:String = param2;
			var total:uint = param3;
			var count:uint = param4;
			var completed:Boolean = param5;
			var challengename:String = param6;
			var type:String = param7;
			var timeRemaining:Number = param8;
			var imagePath:String = param9;
			...
			Animate.to(this.m_view.overlay, 0.8, 0, {"scaleX": scaleFactorX, "alpha": 0}, Animate.ExpoOut);
			...
			Animate.delay(this.m_view, timeRemaining - 0.5, function():void
			{
				...
				Animate.to(m_view, 0.5, 0, {"x": 400, "alpha": 0}, Animate.ExpoOut);
			});
		}
		...
		private function showCompleted(param1:String):void
		{
			...
			this.m_loader.loadImage(imagePath, function():void
			{
				...
				Animate.delay(m_view.imageoverlay, 0.5, function():void
				{
					...
					Animate.to(m_view.imageoverlay, 0.8, 0, {"scaleX": scaleFactor02, "scaleY": scaleFactor02, "alpha": 0}, Animate.ExpoOut);
					Animate.delay(m_view.completediconsoverlay, 0.3, function():void
					{
						...
						Animate.to(m_view.completediconsoverlay, 0.8, 0, {"scaleX": scaleFactor01, "scaleY": scaleFactor01, "alpha": 0}, Animate.ExpoOut);
					});
				});
			});
		}
