package hud
{
	...
	public class StatusMicroMarkersVR extends BaseControl
	{
		...
		private function updateIndicators():void
		{
			...
			Animate.to(this.m_tensionIndicatorMc, 0.5, 0, {"x": _loc3_ * _loc1_, "scaleX": _loc3_ * _loc2_, "scaleY": _loc2_}, Animate.ExpoOut);
			...
			Animate.to(this.m_informationBarLVA, 0.5, 0, {"x": _loc3_ * _loc1_, "scaleX": _loc3_ * _loc2_, "scaleY": _loc2_}, Animate.ExpoOut);
			if (this.m_isLVAIndicatorVisible)
			{
				_loc1_ += this.m_widthIndicator + DX_GAP_BETWEEN_INDICATORS;
			}
			_loc2_ = this.m_isTrespassingIndicatorVisible ? 1 : 0;
			Animate.to(this.m_trespassingIndicatorMc, 0.5, 0, {"x": _loc3_ * _loc1_, "scaleX": _loc3_ * _loc2_, "scaleY": _loc2_}, Animate.ExpoOut);
		}
