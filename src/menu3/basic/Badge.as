	...
	public class Badge extends Sprite implements AnimationContainerBase
	{
		...
		private function showBadge(param1:Boolean):void
		{
			...
			if (this.m_useAnimation)
			{
				...
				if (firstTime)
				{
					Animate.addFromTo(this.m_view, 0.3, delay, {"scaleX": this.m_badgeScaleValue + 0.25, "scaleY": this.m_badgeScaleValue + 0.25}, {"scaleX": this.m_badgeScaleValue, "scaleY": this.m_badgeScaleValue}, Animate.BackOut);
				}
				else
				{
					Animate.addTo(this.m_view, 0.1, delay, {"scaleX": this.m_badgeScaleValue - 0.2, "scaleY": this.m_badgeScaleValue - 0.2}, Animate.SineIn, function():void
					{
						Animate.addTo(m_view, 0.15, 0, {"scaleX": m_badgeScaleValue, "scaleY": m_badgeScaleValue}, Animate.BackOut);
					});
				}
				Animate.fromTo(this.m_badgeFXClip.fxInner, 0.5, delay + 0.1, {"alpha": 1}, {"alpha": 0}, Animate.SineOut);
				Animate.addFromTo(this.m_badgeFXClip.fxInner, 0.6, delay + 0.1, {"scaleX": 1, "scaleY": 1}, {"scaleX": 2.5, "scaleY": 2.5}, Animate.SineOut);
				Animate.fromTo(this.m_badgeFXClip.fxOuter, 0.7, delay + 0.2, {"alpha": 1}, {"alpha": 0}, Animate.SineOut);
				Animate.addFromTo(this.m_badgeFXClip.fxOuter, 0.8, delay + 0.2, {"scaleX": 1, "scaleY": 1}, {"scaleX": 1.5, "scaleY": 1.5}, Animate.SineOut);
			}
			else
			{
				this.m_view.alpha = 1;
