...
//menu3.basic.OptionsInfoTopLeftPreview
...
public dynamic class OptionsInfoTopLeftPreview extends OptionsInfoPreview {
	...
	private var m_objectivesBar:ObjectivesBar = new ObjectivesBar();
	private var m_pipImageScaler:Sprite = new Sprite();
	private var m_pipImageLoader:ImageLoader = null;
	private var m_pipMask:Shape = new Shape();
	private var m_pipElement:PipElement = new PipElement();
	private var m_fScale:Number = 1;
	private var m_idTimeoutObjectives:uint = 0;

	public function OptionsInfoTopLeftPreview(_arg_1:Object) {
		super(_arg_1);
	...
	private function makeObjectivesData(_arg_1:Boolean, _arg_2:Boolean):Object {
		return ({
			"primary": [{
				"id": "AAAAAAAAAAA",
				"objTitle": this.m_lstrObjectiveA,
				"objType": 0
			}, {
				"id": "BBBBBBBBBBB",
				"objTitle": this.m_lstrObjectiveB,
				"objType": 0
			}, {
				"id": "CCCCCCCCCCC",
				"objTitle": this.m_lstrObjectiveC,
				"objType": 0,
				"objSuccess": _arg_1,
				"objChanged": _arg_2
			}],
	...
	private function showPiPStep1():void {
		...
		Animate.fromTo(this.m_pipImageScaler, 6.5, 0, {
			"scaleX": (0.5 * this.m_fScale),
			"scaleY": (0.5 * this.m_fScale)
		}, {
			"scaleX": (0.35 * this.m_fScale),
			"scaleY": (0.35 * this.m_fScale)
		}, Animate.SineOut);
	}
