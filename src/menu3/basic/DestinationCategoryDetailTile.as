package menu3.basic
{
	...
	public dynamic class DestinationCategoryDetailTile extends MenuElementLockableContentBase
	{
		...
		public function DestinationCategoryDetailTile(param1:Object)
		{
		...
		override public function onSetData(param1:Object):void
		{
			...
			if (this.m_enableInfo)
			{
				this.setupInfo(param1.infoicon, param1.infotitle, param1.infoline1, param1.infoline2);
			}
			else
			{
				this.setupInfo("", "", "", "");
		...
		private function setupInfo(param1:String, param2:String, param3:String, param4:String):void
		{
			if (param1.length > 0)
			{
				...
				MenuUtils.setupIcon(this.m_view.info.icon, param1, MenuConstants.COLOR_GREY_DARK, true, false);
			}
			else
			{
				this.m_view.info.icon.visible = false;
			}
			MenuUtils.setupText(this.m_view.info.title, param2, 24, MenuConstants.FONT_TYPE_MEDIUM, MenuConstants.FontColorGreyUltraLight);
			MenuUtils.setupText(this.m_view.info.line1, param3, 18, MenuConstants.FONT_TYPE_NORMAL, MenuConstants.FontColorGreyUltraLight);
			MenuUtils.setupText(this.m_view.info.line2, param4, 18, MenuConstants.FONT_TYPE_NORMAL, MenuConstants.FontColorGreyUltraLight);
