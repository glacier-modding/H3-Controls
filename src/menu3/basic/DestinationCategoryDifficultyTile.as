...
//menu3.basic.DestinationCategoryDifficultyTile
...
public dynamic class DestinationCategoryDifficultyTile extends MenuElementLockableContentBase {
	...
	public function DestinationCategoryDifficultyTile(_arg_1:Object) {
		super(_arg_1);
	...
	private function setupDifficultyInfo(_arg_1:String, _arg_2:String, _arg_3:String):void {
		var _local_4:String = Localization.get((("UI_DIFFICULTY_" + _arg_2) + "_TITLE"));
		MenuUtils.setupIcon(this.m_view.info.icon, "difficultylevel", MenuConstants.COLOR_GREY_DARK, true, false);
		MenuUtils.setupText(this.m_view.info.difficultyheader, _arg_1, 18, MenuConstants.FONT_TYPE_NORMAL, MenuConstants.FontColorGreyUltraLight);
		MenuUtils.setupText(this.m_view.info.difficultytitle, _local_4, 24, MenuConstants.FONT_TYPE_MEDIUM, MenuConstants.FontColorGreyUltraLight);
		MenuUtils.setupText(this.m_view.info.completion, _arg_3, 18, MenuConstants.FONT_TYPE_NORMAL, MenuConstants.FontColorGreyUltraLight);
