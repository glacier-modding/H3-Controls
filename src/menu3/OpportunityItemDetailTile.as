...
//menu3.OpportunityItemDetailTile
...
public dynamic class OpportunityItemDetailTile extends MenuElementBase {
	...
	public function OpportunityItemDetailTile(_arg_1:Object) {
		super(_arg_1);
	}
	...
	private function setupBody(_arg_1:String, _arg_2:String):void {
		MenuUtils.setupText(this.m_view.Body.title, _arg_1, 28, MenuConstants.FONT_TYPE_MEDIUM, MenuConstants.FontColorWhite);
