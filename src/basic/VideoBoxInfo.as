package basic
{
	...
	public class VideoBoxInfo extends Sprite
	{
		...
		{
			this.m_loadIndicator.ShowLoadindicator({"discrete": false, "icon": "load", "header": this.m_loadingString, "showbarcodes": true});
		...
		private function configureSkipPrompt():void
		{
			...
			_loc1_.buttonprompts = new Array({"actiontype": "cancel", "actionlabel": this.m_skipString, "hideIndicator": true, "platform": this.m_platformString});
